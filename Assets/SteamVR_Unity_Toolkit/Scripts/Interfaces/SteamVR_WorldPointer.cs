...
public class SteamVR_PlayAreaCollider : MonoBehaviour
{
    ...
    {
        if (!collider.name.Contains("WorldPointer_"))
        {
...
public abstract class SteamVR_WorldPointer : MonoBehaviour {
    ...
    public bool displayPlayAreaCursor = false;
    ...
    {
        bool playAreaState = (displayPlayAreaCursor ? state: false);
    ...
    private void DrawPlayAreaCursorBoundary(int index, float left, float right, float top, float bottom, float thickness, Vector3 localPosition)
    {
        ...
        playAreaCursorBoundary.name = "WorldPointer_PlayAreaCursorBoundary_" + index;
    ...
    private void InitPlayAreaCursor()
    {
        ...
        playAreaCursor.name = "WorldPointer_PlayAreaCursor";
        ...
        playAreaCursorCollider.center = new Vector3(0f, 1f, 0f);
