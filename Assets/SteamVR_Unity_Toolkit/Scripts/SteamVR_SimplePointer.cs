...
public class SteamVR_SimplePointer : SteamVR_WorldPointer
{
    ...
    {
        pointerHolder = new GameObject("WorldPointer_SimplePointer_Holder");
        pointerHolder.transform.parent = this.transform;
        pointerHolder.transform.localPosition = Vector3.zero;

        pointer = GameObject.CreatePrimitive(PrimitiveType.Cube);
        pointer.transform.name = "WorldPointer_SimplePointer_Pointer";
        ...
        pointerTip.transform.name = "WorldPointer_SimplePointer_PointerTip";
